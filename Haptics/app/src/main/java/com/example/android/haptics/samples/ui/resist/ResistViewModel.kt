    ...
    companion object {
        ...
        fun provideFactory(
            ...
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                ...
                val isTickSupported = Build.VERSION.SDK_INT >= Build.VERSION_CODES.S && vibrator.areAllPrimitivesSupported(
                    VibrationEffect.Composition.PRIMITIVE_LOW_TICK
                )
                val isLowTickSupported = Build.VERSION.SDK_INT >= Build.VERSION_CODES.R && vibrator.areAllPrimitivesSupported(
                    VibrationEffect.Composition.PRIMITIVE_LOW_TICK
                )

                // The message to display to user if we detect that the designed experience will
                // not work correctly at all or that it will be degraded.
                var messageToUser = ""
